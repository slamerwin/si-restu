    ...
    var table1 = $('#dataTablePermintaan1').DataTable({
        ...
        "columns": [
          ...
          
            {
                ...
                "render": function (data, type, full, meta) {
                    var actions = []; 
                    actions.push('<a onclick="buat(' + data + ')" class="btn btn-xs btn-success" data-toggle="modal" data-target="#exampleModal3" title="Buat SK" data-content="Buat"><i class="fas fa-file-medical"></i></a>');
                    actions.push('<a onclick="buka(' + data + ')" class="btn btn-xs btn-success" data-toggle="modal" data-target="#exampleModal2" title="Rekomendasi Pembuatan SK" data-content="Ubah"><i class="fas fa-file-invoice"></i></a>');
        ...
        var table2 = $('#dataTablePermintaan2').DataTable({
          "Dom": 'RlfrtlipB',
          "ordering":false,
          "processing": true,
          "serverSide": true,
