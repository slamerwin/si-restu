var table = $('#dataTableHonor').DataTable({
    "Dom": 'RlfrtlipB',
    "ordering":false,
    "processing": true,
    "serverSide": true,
    "ajax": {
        "url": window.location.origin+'/honor/dataHonor',
    },
    "columns": [
        {
        "data": "rownum"
    ...
    var table1 = $('#dataTableHonor1').DataTable({
      "Dom": 'RlfrtlipB',
      "ordering":false,
      "processing": true,
      "serverSide": true,
    ...
    function up(id) {
        $.ajax({
            type: 'POST',
            url: window.location.origin+'/honor/edit',
            data: {id:id},
      ...
      function del(id) {
        Swal.fire({
          ...
          if (result.value) {
            $.ajax({
                type: 'POST',
                url: window.location.origin+'/honor/delet',
                data: {id:id},
                success: function() {
