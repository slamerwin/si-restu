...
<div class="card shadow mb-4">
    ...
    <?php }else{?>
        <table class="table table-bordered" id="dataTablePermintaan2" width="100%" cellspacing="0">
    <?php } ?>
            <thead>
                <tr>
                    <th>No</th>
        ...
        <div class="modal-content">
            ...
            <form  action="<?php echo base_url('permintaan/buatSK') ?>" method="post" id="buatDataPermintaan" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <textarea rows="6" class="form-control form-control-user" id="tentang2" name="tentang2" placeholder="Tentang" value="<?= old('tentang') ?>"></textarea>
                    </div>
                    <div class="form-group">
