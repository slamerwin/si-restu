 ...
 */
class GibberishAES extends Model {
    ...
    private $password = 'eyJ0eXAiOiJKV76365577288635276126721555I6IjEwOTgiLCJ1c2VybmFtZSI6InBzbXRpIiwicGFzcyI6InBzbXRpIn0.I05x-2X7WYeDVoZbmCOypcoddPj4I9yWl9Fi47-lh-M';
    private $method   = 'aes-128-cbc'; // AES 256 CBC (chipher block chaining)
    ...
    // FUNGSI ENCRYPT AES
        ...
        public function decrypt_data($data){
                ...
                $decrypted = openssl_decrypt(base64_decode($d), $this->method, $password, OPENSSL_RAW_DATA, $iv);
